...
export class MainLayout {
  ...
  socios: Socio[] = [
    {
      id: '01', nombres: 'Felipe Carlos', apellidos: 'Guzmán Segundo',
      correo: 'FelipeCarlosGuzman@gmail.com', tel: '+34 652 25 35 97',
      dni: '52316377W', estado: 'Activo', fechaVenc: '05/01/2027',
      profesor: 'Si', contrasena: 'vW2O8a9z7', selected: false
    },
  ];
